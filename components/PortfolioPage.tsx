    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/30">
      ...
      <div className="relative mx-auto max-w-[1400px] p-3 sm:p-4 lg:p-5">
        ...
        <main className="grid min-w-0 flex-1 grid-cols-1 gap-3 xl:grid-cols-[1.1fr_0.9fr] xl:gap-4">
          {/* HERO */}
          <Card id="hero" className="relative overflow-hidden p-6 sm:p-7 lg:p-8">
            ...
            <div className="relative max-w-sm">
              ...
              <a
                href="/resume"
                className="group mt-5 flex items-center justify-between gap-3 overflow-hidden rounded-2xl border border-primary/25 bg-gradient-to-r from-primary/10 via-surface-bright to-neon/5 px-4 py-3 transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10"
              >
          ...
          {/* STATS + STACK */}
          <div id="stats" className="grid gap-2">
            <Card className="p-4 sm:p-5" delay={80}>
              <Label icon={BarChart3}>Estatísticas</Label>
              <div className="mx-auto grid w-full max-w-3xl grid-cols-1 gap-2 sm:grid-cols-3 sm:gap-3">
                {STATS.map(({ icon: Icon, value, label }) => (
                  <div
                    key={label}
                    className="flex w-full max-w-[180px] flex-col items-center justify-center rounded-2xl border border-border bg-surface-bright/60 p-3 text-center sm:max-w-none"
                  >
                    <Icon
